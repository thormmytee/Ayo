...
FLUAT;------This column should only take the values 35, 30, 15 and 10 
ALTER TABLE LOAN.LOANSETUOINFORMATION
ADD CONSTRAINT DF_LOANSETUPINFORMATION_LoanTerm DEFAULT(35301510) FOR LOANTERM;
